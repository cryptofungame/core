...
@section('content')
{!! Form::open(array('action' => ['AdminController@store'] ,'class' => 'form-horizontal','id' => 'myform', 'files' => true)) !!}
<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>افزودن سوال
							</div>
							<div class="tools">
								...
								<div class="tab-pane fade active in">
										...
										<!-- BEGIN FORM-->
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-group">
															{!! Form::number('priority',$max, array('class' => 'form-control input-circle','required' => 'required')) !!}
														</div>
												...
												<div class="form-group">
													<label for="image_source" class="col-md-3 control-label">انتخاب تصویر سوال</label>
													<div class="col-md-4">

															{!! Form::file('image_source',array('required' => 'required')) !!}
													
													</div>
												</div>

												<div class="form-group">
													<label for="answer_image" class="col-md-3 control-label">انتخاب تصویر پاسخ</label>
													<div class="col-md-4">
						 ...
						 <div class="form-actions">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														{!! Form::submit('ثبت سوال', array('class' => 'btn btn-circle blue')) !!}
